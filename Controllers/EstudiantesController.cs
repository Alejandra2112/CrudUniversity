...
namespace CrudUniversity.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string searchString)
        {
            ...
            //            Problem("Entity set 'ApplicationDbContext.Estudiante'  is null.");
            ViewData["NameSortParm"] = String.IsNullOrEmpty(sortOrder) ? "name_desc" : "";
            ViewData["DateSortParm"] = sortOrder == "Date" ? "date_desc" : "Date";
            ViewData["CurrentFilter"] = searchString;

            var estudiantes = from s in _context.Estudiante
                              select s;
            if (!String.IsNullOrEmpty(searchString))
            {
                estudiantes = estudiantes.Where(s=> s.Nombre.Contains(searchString) || s.Apellido.Contains(searchString));
        ...
        public async Task<IActionResult> Create([Bind("IdEstudiante,Nombre,Apellido,FechaInscripcion")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstudiante,Nombre,Apellido,FechaInscripcion")] Estudiante estudiante)
        {
